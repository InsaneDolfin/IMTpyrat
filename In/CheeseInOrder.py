...
##############################################################################
"""
On Ordonne la liste piecesOfCheese en fonction des distances calculées avec Dijkstra
"""

#calcul de l'ordre : playerLocation --> fromage 0
...
#calcul de l'ordre : playerLocation --> fromage 0 puis fromage i --> fromage i+1
def cheeseInOrderAll(mazeMap,playerLocation,piecesOfCheese):
    global cheeseInOrderAll
    cheeseInOrderAll=[]
...
def chemin_total(mazeMap,playerLocation,cheeseInOrderAll):
    global chemin
    chemin_intermediaire=[]
    chemin=chemin_court(mazeMap,playerLocation,cheeseInOrderAll,0)
    for i in range (1,len(cheeseInOrderAll)):
        chemin_intermediaire=chemin_court(mazeMap,cheeseInOrderAll[i-1],cheeseInOrderAll,i)
...
def preprocessing (mazeMap, mazeWidth, mazeHeight, playerLocation, opponentLocation, piecesOfCheese, timeAllowed) :
    ...
    print("<b>[chemin total le plus court]</b> " + str(chemin_total(mazeMap,playerLocation,piecesOfCheese)))
